...
function SpiegazioneView() {
  return <section className="explanation">
    ...
    <h2>Il tuo bot vive sul Pico</h2><p>Collega il tuo RP2040 via USB, premi «Connetti» e poi «Carica sul Pico» nel Laboratorio. Potete sfidarvi con due Pico sullo stesso computer oppure aprire una <a href="remote/">stanza online per il Tris</a>, ognuno con la propria scheda.</p><h2>Quando vuoi fare un passo in più</h2>
