...
function SpiegazioneView() {
  return (
    <section className="view">
      ...
      <h2>In tre passi</h2>
      <ol className="steps">
        <li><strong>Scrivi il tuo bot</strong><span>In MicroPython: legge lo stato del gioco
          come riga JSON da stdin e risponde con la sua mossa, sempre in JSON, su stdout.</span></li>
        <li><strong>Caricalo sul Pico</strong><span>Copia il codice come <code>main.py</code>{' '}
          sul tuo RP2040 (con Thonny o <code>mpremote</code>), oppure usa il{' '}
          <a href="editor/">Laboratorio</a> e caricalo dal browser.</span></li>
